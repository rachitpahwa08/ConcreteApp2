...
public class PlacedOrderFragment extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        call.enqueue(new Callback<History>() {
            ...
            public void onResponse(Call<History> call, Response<History> response) {
                ...
                {
                    empty=(TextView)view.findViewById(R.id.placedordertext);
                    empty.setText("No Orders Were Placed");
                }
                else{
                    View b = view.findViewById(R.id.placedordertext);
